        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[calc(100vh-8rem)]">
          ...
          <div className="space-y-8 text-center lg:text-left">
            ...
            <p className="text-muted-foreground text-lg max-w-lg mx-auto lg:mx-0">
              Experience the perfect blend of flavors with our signature gourmet
              burgers, crafted with love and the finest ingredients.
            </p>
            ...
            <div className="flex items-center justify-center lg:justify-start gap-4 pt-4">
              ...
              <Link
                href="#"
                className="w-10 h-10 rounded-full bg-card border  flex items-center justify-center hover:bg-primary hover:border-primary transition-colors group cursor-pointer "
              >
                <Facebook className="w-4 h-4 text-muted-foreground group-hover:text-primary-foreground" />
              </Link>
              <Link
                href="#"
                className="w-10 h-10 rounded-full bg-card border border-border flex items-center justify-center hover:bg-primary hover:border-primary transition-colors group"
              >
